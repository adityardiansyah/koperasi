			...
			<div class="row">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content" style="width: 600px;">
				      ...
				      <form action="/pegawai/{{$edit->id}}" method="POST">
				      
				      <div class="modal-body">
						  <div class="form-group">
						    <label for="formGroupExampleInput">Nama Pegawai</label>
						    <input type="text" name="nama_pegawai" class="form-control" id="formGroupExampleInput" value="{{ $edit->nama_pegawai}}">
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <input type="text" name="pendidikan" class="form-control" id="formGroupExampleInput2" value="{{ $edit->pendidikan}}">
						  </div>
						  <div class="form-group">
						    <label for="formGroupExampleInput2">Tanggal Lahir</label>
						    <input type="date" name="tgl_lahir" class="form-control" id="formGroupExampleInput2" value="{{ $edit->tgl_lahir}}">
						  </div>
